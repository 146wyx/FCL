...
namespace FunCraftLauncher.Views
{
    public partial class SettingsDialog : Window
    {
        ...
        private void LoadSettings()
        {
            ...
            MinimizeToTrayCheck.IsChecked = _settings.Launcher.MinimizeToTray;
            AutoLoginCheck.IsChecked = _settings.Launcher.AutoLogin;
            RememberPasswordCheck.IsChecked = _settings.Launcher.RememberPassword;
            CheckUpdateOnStartCheck.IsChecked = _settings.Launcher.CheckUpdateOnStart;
        ...
        private void SaveSettingsFromUI()
        {
            ...
            _settings.Launcher.MinimizeToTray = MinimizeToTrayCheck.IsChecked == true;
            _settings.Launcher.AutoLogin = AutoLoginCheck.IsChecked == true;
            _settings.Launcher.RememberPassword = RememberPasswordCheck.IsChecked == true;
            _settings.Launcher.CheckUpdateOnStart = CheckUpdateOnStartCheck.IsChecked == true;
